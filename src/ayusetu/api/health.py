...
===========================
Provides health and readiness endpoints validating PostgreSQL and Redis connectivity.
"""
...
def liveness() -> Dict[str, str]:
    ...
    return {"status": "ok", "service": "ayusetu-backend", "env": settings.AYUSETU_ENV}
...
def readiness(response: Response) -> Dict[str, Any]:
    ...
    Returns 200 if all critical backends are available, 503 if any failed.
    """
    db_ok = False
    redis_ok = False
